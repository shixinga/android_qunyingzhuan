...
public class ViewGroupB extends LinearLayout {
    ...
    public boolean dispatchTouchEvent(MotionEvent ev) {
        Log.d(MainActivity.TAG, "dispatchTouchEvent ViewGroup BBB: ");
        boolean flag = super.dispatchTouchEvent(ev);
        Log.d(MainActivity.TAG, "ViewGroup B dispatchTouchEvent: event.action=" + ev.getAction()
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        Log.d(MainActivity.TAG, "onInterceptTouchEvent ViewGroup BBB: ");
        boolean flag = super.onInterceptTouchEvent(ev);
        Log.d(MainActivity.TAG, "ViewGroup B onInterceptTouchEvent: event.action=" + ev.getAction()
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        Log.d(MainActivity.TAG, "ViewGroup B onTouchEvent: event.action=" + event.getAction()
